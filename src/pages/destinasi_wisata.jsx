...
const DestinasiWisata = () =>{
    ...
    <main className="container content-wrapper">
        <h1 className="text-shadow">Destinasi Wisata yang Tersedia</h1>
        <p className="text-shadow">Silakan pilih destinasi yang kamu inginkan.</p>
        ...
        {destinasiData.map(destinasi =>(
            <div className="card col-4 col-sm-12 p-0" style={{ width: '18rem' }}>
                <img src="assets/images/pura-tanah-lot-tempel-am-meer-istock-494560541.jpg" className="card-img-top"
                    alt="pura tanah lot"/>
                <div className="card-body">
                    ...
                    <Link to={`/booking/${destinasi.slug}`} className="btn btn-primary w-100">Pilih</Link>
            </div>
            </div>
        ))};
        </section>
