...
<head>
    ...
    <title>Tambah Data User | PesanWisata App</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="">Data Booking</a>
                    </li>
                </ul>
    ...
    <main class="container content-wrapper" style="min-height: 80vh;">
        ...
        <h1 class="text-shadow">Tambah Data User</h1>
        <p class="text-shadow">Di halaman ini, kamu dapat mendaftarkan user baru.</p>
        <div class="card p-4">
