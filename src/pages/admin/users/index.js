...
<head>
    ...
    <title>Data User | PesanWisata App</title>
...
<body>
    ...
    <main class="container content-wrapper" style="min-height: 80vh;">
        ...
        <div class="card p-4 table-responsive">
            <a href="add.html" class="btn btn-primary mb-3">Tambah</a>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="btn btn-danger" onclick="return confirm('Apakah anda yakin? Tindakan ini mungkin memengaruhi data user ini di tabel lain.')">Hapus</a>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">2</th>
