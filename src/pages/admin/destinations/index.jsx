...
const DataDestinasi = () => {
  ...
  if (loading) return <p className="text-center mt-5">Sedang mengambil data destinasi...</p>;
  if (error)
    return (
    ...
    <div>
      ...
      <main className="container content-wrapper">
        ...
        <p className="text-shadow">
          Di halaman ini, kamu dapat melihat destinasi wisata yang sudah terdaftar.
        </p>
        <div className="card p-4 table-responsive">
          <Link to="/tambah-destinasi" className="btn btn-primary mb-3">
            Tambah
          </Link>
            ...
            <tbody>
              {destinationsData.map((destination, index) => (
                <tr key={destination.id}>
                  ...
                  <td>
                    <Link
                      to={`/edit-destinasi/${destination.id}`}
